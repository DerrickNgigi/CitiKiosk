...
(function ($){
    ...
    jQuery(document).ready(function () {
       ...
       var axsistestimonialContainer = new Swiper('.axsis-testimonial-container', {
        ...
        // testimonial swiper slider init
        var axsistestimonialContainer = new Swiper('.axsis-testimonial-container3', {
            spaceBetween: 30,
            slidesPerView: 3,
            loop: true,
            // autoplay: {
        ...
        // testimonial swiper slider init
       var axsistestimonialContainer = new Swiper('.axsis-testimonial-container2', {
            spaceBetween: 60,
            slidesPerView: 1,
            loop: true,
            // autoplay: {
       ...
       // to top js
        ...
        $(window).load(function() {
            ...
            $(".demo-bar").click(function(){
              $("body").toggleClass("open-side-demos");
            });
        ...
        $('.accordion>.faq button').on('click', function(e) {
            var element = $(this).parents('.faq');
            // console.log(element);
            if (element.hasClass('open')) {
                element.removeClass('open');
                // element.find('.faq').removeClass('open');
                // element.find('ul').slideUp(1500,"swing");
            }
            else {
                element.addClass('open');
